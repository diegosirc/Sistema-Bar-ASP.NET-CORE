        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<Negocio, VMNegocio>()
                .ForMember(destino =>
                    ...
                    opt => opt.MapFrom(origen => Convert.ToString(origen.PorcentajeImpuesto.Value, new CultureInfo("es-ARG")))
                );

            CreateMap<VMNegocio , Negocio>()
               .ForMember(destino =>
                   destino.PorcentajeImpuesto,
                   opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PorcentajeImpuesto, new CultureInfo("es-ARG")))
               );
           ...
           .ForMember(destino =>
            ...
            CreateMap<Venta,VMVenta>()
                ...
                .ForMember(destino =>
                    destino.SubTotal,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.SubTotal.Value, new CultureInfo("es-ARG")))
                )
                .ForMember(destino =>
                    destino.ImpuestoTotal,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.ImpuestoTotal.Value, new CultureInfo("es-ARG")))
                )
                 .ForMember(destino =>
                    destino.Total,
            ...
            .ForMember(destino =>
             ...
             .ForMember(destino =>
              ...
              .ForMember(destino =>
                  ...
                  opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.SubTotal.Value, new CultureInfo("es-ARG")))
              )
              .ForMember(destino =>
                  destino.ImpuestoTotalVenta,
                  opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.ImpuestoTotal.Value, new CultureInfo("es-ARG")))
              )
               .ForMember(destino =>
                  destino.TotalVenta,
